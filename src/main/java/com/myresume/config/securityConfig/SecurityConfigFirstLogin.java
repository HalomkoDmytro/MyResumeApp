...
@Configuration
@Order(0)
public class SecurityConfigFirstLogin extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                .antMatcher("/first-sign-in/**")
                .formLogin()
                .loginPage("/first-sign-in/sign-in-first")
                .loginProcessingUrl("/first-sign-in/sign-in-first-handler")
